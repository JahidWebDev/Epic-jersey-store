...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center px-4 py-10 bg-gray-50">
      ...
      {/* CATEGORY */}
      <h1 className="text-2xl md:text-4xl font-bold mb-10 text-center text-gray-600">
        Shop by Categories
      </h1>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl mb-16">

        <Link to="/category/full-sleeve-jersey"
          className="bg-black text-white rounded-2xl p-8 flex flex-col items-center gap-4"
        >
          <FaTshirt className="text-6xl" />
          Full Sleeve Jersey
        </Link>

        <Link to="/category/half-sleeve-jersey"
          className="bg-gray-200 text-black rounded-2xl p-8 flex flex-col items-center gap-4"
        >
          <FaTshirt className="text-6xl" />
          Half Sleeve Jersey
        </Link>

        <Link to="/category/short-pants"
          className="bg-gray-200 text-black rounded-2xl p-8 flex flex-col items-center gap-4"
        >
          <GiTrousers className="text-6xl" />
          Short Pants
        </Link>
        ...
        <Link to="/collections"
          className="bg-black text-white rounded-2xl p-8 flex flex-col items-center gap-4"
        >
          <MdOutlineCollections className="text-6xl" />
          All Collections
        </Link>
